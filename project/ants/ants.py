...
class Bee(Insect):
    ...
    def action(self, gamestate):
        ...
        elif self.armor > 0 and destination is not None and not self.backwards:
            self.move_to(destination)
        elif self.armor > 0 and self.place.entrance is not None and self.backwards:
